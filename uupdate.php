...
$id = $_GET['id_alat'];
$crudQuery = mysqli_query($koneksi,"SELECT * FROM user WHERE id_alat = $id");
                ...
                <form action="aaksi.php" method="POST">
                    ...
                    <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" id="idd" name="idd" value="<?= $user['id_alat'] ?>">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <td><input type="submit" name="editt" value="Simpan"> </td>
                            </div>
                    </div>
                </form>
            </div>
